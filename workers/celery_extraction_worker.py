...
def extract_bulk(self, file_paths: list, format_override: str = None, options: dict = None, job_id: str = None):
            ...
            try:
                ...
                if format_override:
                    try:
                        ...
                        logger.warning(f"Invalid format_override: {format_override}, using auto-detect")
    ...
    try:
        ...
        result_dict = {
            ...
            "overall_status": response.overall_status.value if hasattr(response.overall_status, "value") else str(response.overall_status),
