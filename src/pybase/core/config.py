...
class Settings(BaseSettings):
    ...
    # SAML Configuration
    # ==========================================================================
    saml_sp_entity_id: str = Field(default="pybase", description="SAML Service Provider entity ID")
    ...
    def saml_enabled(self) -> bool:
        ...
        return self.sso_enabled and bool(self.saml_idp_metadata_url or self.saml_idp_metadata_file)
    ...
    oidc_prompt: str | None = Field(default=None, description="OIDC prompt (login, consent, etc.)")
    ...
    trash_retention_days: int = Field(
        default=30, description="Number of days to retain soft-deleted items"
    )
